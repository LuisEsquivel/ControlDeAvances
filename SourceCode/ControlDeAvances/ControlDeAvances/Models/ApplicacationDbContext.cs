...
{
    public partial class ApplicacationDbContext : DbContext
    {
        public ApplicacationDbContext()
        {
        }

        public ApplicacationDbContext(DbContextOptions<ApplicacationDbContext> options)
            : base(options)
        {
        }
